...
\newcommand{\contributor}[4]{%
  ...
  \begin{tcolorbox}[
    ...
    {\footnotesize\color{gray}\itshape #4}
  \end{tcolorbox}
}
...
\vspace{0.5cm}
\tikz{\draw[accent, line width=0.8pt] (0,0) -- (6cm,0);}
\vspace{0.5cm}
\end{center}
...
\article{\centering Quantum Computing: Unlocking the Future of Computation}{Sultana Akter}{\today}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=.9\textwidth]{group_photo.jpg}
\end{figure}
\vspace{3.5cm}
\vspace{1.3cm}
